...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final appTextTheme = GoogleFonts.montserratTextTheme(baseTheme.textTheme).copyWith(
      titleLarge: GoogleFonts.montserrat(textStyle: baseTheme.textTheme.titleLarge),
      titleMedium: GoogleFonts.montserrat(textStyle: baseTheme.textTheme.titleMedium),
      titleSmall: GoogleFonts.montserrat(textStyle: baseTheme.textTheme.titleSmall),
    );
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          SizedBox(width: Dim.s),
          Expanded(child: Text(title, maxLines: 1, overflow: TextOverflow.ellipsis, style: textTheme.bodySmall?.copyWith(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.65)))),
        ]),
        SizedBox(height: Dim.s),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        SizedBox(width: Dim.m),
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(name, style: textTheme.titleSmall), SizedBox(height: Dim.xs), Text(ordersText, style: textTheme.bodySmall?.copyWith(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.65)))])),
